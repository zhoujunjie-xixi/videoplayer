...
from videoform import Ui_Video_Form
...
class MainWindowForm(QtWidgets.QMainWindow,  Ui_Video_Form):
    def __init__(self):
        ...
        self.pushButton.clicked.connect(self.Prev_Frame_Slot)
        self.pushButton_2.clicked.connect(self.Next_Frame_Slot)
        self.choose_btn.clicked.connect(self.Save_Slot)
        self.slider.sliderMoved.connect(self.SliderMove_Slot)
