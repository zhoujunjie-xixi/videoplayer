...
# Form implementation generated from reading ui file 'videoform.ui'
#
...
"")
        ...
        self.slider.setGeometry(QtCore.QRect(60, 410, 731, 16))
        self.slider.setStyleSheet("")
        self.slider.setOrientation(QtCore.Qt.Horizontal)
        self.slider.setObjectName("slider")
        self.layoutWidget = QtWidgets.QWidget(self.centralWidget)
        self.layoutWidget.setGeometry(QtCore.QRect(50, 450, 741, 61))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(600, 360, 191, 41))
    ...
    def retranslateUi(self, Video_Form):
        ...
        self.pushButton.setText(_translate("Video_Form", "<<前一帧"))
        self.start_btn.setText(_translate("Video_Form", "播放/暂停"))
        self.pushButton_2.setText(_translate("Video_Form", "后一帧>>"))
        self.label_mag.setText(_translate("Video_Form", " 0"))
        self.choose_btn.setText(_translate("Video_Form", "保存"))
